...
from modeling_roberta_svo_graph import RobertaForMultipleChoice
...
def main():
    ...
    tokenizer.add_special_tokens({'additional_special_tokens':['[neg]', '[pos]']})
    ...
    if args.do_eval and args.local_rank in [-1, 0]:
        ...
        for checkpoint in checkpoints:
            ...
            model = model_class.from_pretrained(checkpoint, max_doc_len=args.max_doc_len, max_query_len=args.max_query_len, max_option_len=args.max_option_len)
            model.to(args.device)
    ...
    if args.do_test and args.local_rank in [-1, 0]:
        ...
        model = model_class.from_pretrained(checkpoint_dir, max_doc_len=args.max_doc_len, max_query_len=args.max_query_len, max_option_len=args.max_option_len)
        model.to(args.device)
